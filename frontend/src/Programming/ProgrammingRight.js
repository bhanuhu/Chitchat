...
const ProgrammingRight=()=>{
    return(<Box sx={{color:'black',boxShadow:4,p:2,mt:-5,ml:140,mr:12 ,position:'absolute',width:300}}>

    <Stack sx={{color:'black'}}>
    <Typography sx={{mt:1 ,fontWeight:'bold',fontSize:25 }}>Programming</Typography>
    <Stack direction='row' sx={{mb:2,ml:6}}>
    <GroupsIcon sx={{ml:3}}> </GroupsIcon>
    <Typography sx={{ml:1}}>33 Members</Typography>
    </Stack>
    <Typography sx={{mr:0}}>A community for programmers to discuss programming languages, frameworks, and software development. From web development to mobile apps, this community has all the code you need to build your next project!</Typography>
    </Stack>
...
export default ProgrammingRight;