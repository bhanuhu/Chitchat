...
const TravelRight=()=>{
    ...
    <Typography sx={{mt:1 ,fontWeight:'bold',fontSize:25 }}>Travel</Typography>
    <Stack direction='row' sx={{mb:2,ml:6}}>
    <GroupsIcon sx={{ml:3}}> </GroupsIcon>
    <Typography sx={{ml:1}}>33 Members</Typography>
    </Stack>
    <Typography sx={{mr:0}}>A community for travel junkies to share their experiences, tips, and recommendations for destinations around the world. From backpacking to luxury travel, this community has all the inspiration you need to plan your next adventure!</Typography>
    </Stack>
