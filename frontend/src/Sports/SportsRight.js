...
const SportsRight=()=>{
    ...
    <Typography sx={{mt:1 ,fontWeight:'bold',fontSize:25 }}>Sports</Typography>
    <Stack direction='row' sx={{mb:2,ml:6}}>
    <GroupsIcon sx={{ml:3}}> </GroupsIcon>
    <Typography sx={{ml:1}}>33 Members</Typography>
    </Stack>
    <Typography sx={{mr:0}}>A community for sports fans to discuss the latest news, events, and teams. From football to basketball, this community has all the action you need to stay up-to-date on your favorite sports!</Typography>
    </Stack>
